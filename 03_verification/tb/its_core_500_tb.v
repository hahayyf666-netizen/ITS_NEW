...
module its_core_500_tb;
    ...
    task push_inputs;
        ...
        integer i;
        begin
            // Stream entries while the DUT is loading.  A full 4x4 TU has
            // 16 coefficients plus the terminating marker, so pushing all
            // 17 entries back-to-back would overflow this depth-16 model.
            for (i = 0; i < count; i = i + 1) begin
                while (input_fifo_full)
                    @(posedge clk_core);
    ...
    initial begin
        ...
        run_test("bp_dct2_64x64", 7'd64, 7'd64, 2'd0, 2'd0, 2'd0, 2'd0,
                 "../tb/test_vectors/dct2_64x64_input.hex",
                 "../tb/test_vectors/dct2_64x64_golden.hex");
        run_test("bp_dct8_32x32", 7'd32, 7'd32, 2'd2, 2'd2, 2'd0, 2'd0,
                 "../tb/test_vectors/dct8_32x32_input.hex",
                 "../tb/test_vectors/dct8_32x32_golden.hex");
        run_test("bp_dst7_32x32", 7'd32, 7'd32, 2'd1, 2'd1, 2'd0, 2'd0,
                 "../tb/test_vectors/dst7_32x32_input.hex",
                 "../tb/test_vectors/dst7_32x32_golden.hex");
