...
- `current/`：V3.5-15 当前说明；Step 12A-R/R2 文档保留为历史门禁记录。
...
其中 A1 32-group FIFO 是历史实验，当前采用 A2 guaranteed-accept kernel contract；V3.5-15 当前一键检查入口为 `../03_verification/scripts/run_current_checks.ps1`。
