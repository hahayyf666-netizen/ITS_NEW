# V3.4 post-route implementation audit.
# OOC module timing, xcku5p-ffvb676-2-e, 2.000 ns (500 MHz).
...
report_timing_summary -file [file join $out_dir v34_timing_summary.rpt]
report_timing -setup -nworst 10 -file [file join $out_dir v34_setup.rpt]
report_timing -hold  -nworst 10 -file [file join $out_dir v34_hold.rpt]
report_utilization -file [file join $out_dir v34_utilization.rpt]
report_power -file [file join $out_dir v34_power.rpt]
write_checkpoint -force [file join $out_dir v34.dcp]

puts "V3.4 implementation complete"
