# V3.5-Step12C-M5-Setup Step12B cycle model
...
|---|---:|---:|---|---:|---:|
| zero | 3161 | 128 | {'vertical': [16], 'horizontal': [16]} | 1024 | 1024 |
| sparse | 3166 | 128 | {'vertical': [16], 'horizontal': [16]} | 1024 | 1024 |
| alternating | 7257 | 128 | {'vertical': [16], 'horizontal': [16]} | 1024 | 1024 |
| random | 7256 | 128 | {'vertical': [16], 'horizontal': [16]} | 1024 | 1024 |

two-TU: {'cycles': 10093, 'result_writes': 2048, 'result_fires': 2048, 'stats': {'input_cache_full': 1024, 'staging_wait': 0, 'result_capacity_wait': 2830, 'output_backpressure': 8000, 'epoch_scrub': 0}}
vector_id_wrap: {'groups': 2048, 'first_ids': [65534, 65535, 0, 1]}
epoch_wrap: {'tus': 10, 'scrub_events': 24576, 'scrub_episodes': {'inputA:1': 4096, 'inputB:1': 4096, 'inputA:2': 4096, 'inputB:2': 4096, 'inputA:3': 4096, 'inputB:3': 4096}, 'other_cache_progress_during_scrub': True, 'scrub_mutation_gate': {'wrong_scrub_index_rejected': True, 'missing_scrub_transaction_rejected': True, 'missing_scrub_bank_rejected': True, 'wrong_scrub_cache_rejected': True, 'scrub_access_rejected': True}, 'cycles': 29969}
